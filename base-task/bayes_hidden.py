...
Conditions per item:
  none        every line visible (Experiment 1's display)
  s2          line s2 hidden
  s4          line s4 hidden
  error_line  the line PRODUCED BY the error is hidden (s1 if the error is at
              ...
              moves the observer, because steps 1 and 3 carry 85% of all the
...
from pool import HYPOTHESES, IDS
from find_pairs import POSITIONS   # (1, 3): the two error positions
